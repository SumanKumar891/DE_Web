...
//       []; // Change to hold URLs and timestamps
//   DateTime? _startDate; // Track selected start date
...
//                   // Calculate the reversed index
//                   int reversedIndex = imageUrls.length - 1 - index;
//                   final image = imageUrls[reversedIndex];
//                   return ListTile(
//                     title: Column(
//                       crossAxisAlignment: CrossAxisAlignment.start,
//                       children: [
//                         Image.network(image['url']!), // Display the image
//                         SizedBox(
//                             height:
//                                 8.0), // Add spacing between image and timestamp
//                         Text(
//                           image['timestamp']!,
//                           style: TextStyle(
...
//         final bodyJson = json.decode(response.body);
//         final imagesData =
//             json.decode(bodyJson['body'])['images'] as List<dynamic>;

//         // Create a list to hold the image URL and timestamp pairs
//         List<Map<String, String>> imageList = [];
//         for (var imageData in imagesData) {
//           // Extract URL and timestamp
//           String url = imageData['url'];
//           String timestamp = imageData['url'].split('/')[3];
//           imageList.add({'url': url, 'timestamp': timestamp});
//         }
...
//   void _downloadAllImages() {
//     // Generate text file content with total count, image URLs, and timestamps
//     int totalCount = imageUrls.length;
//     StringBuffer buffer = StringBuffer();
//     buffer.writeln('Total Images: $totalCount');
//     for (var image in imageUrls) {
//       buffer.writeln('${image['url']} | ${image['timestamp']}');
//     }
