...
class PortutgalScreen extends StatefulWidget {
  @override
  State<PortutgalScreen> createState() => _PortutgalScreenState();
}

class _PortutgalScreenState extends State<PortutgalScreen> {
        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              ...
              Text('Portugal Deployment July 2024 DATA')
            ],
          ),
        ),
        body: ListView(
