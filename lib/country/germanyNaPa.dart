...
class germanyNaPaScreen extends StatefulWidget {
  @override
  State<germanyNaPaScreen> createState() => _germanyNaPaScreenState();
}

class _germanyNaPaScreenState extends State<germanyNaPaScreen> {
