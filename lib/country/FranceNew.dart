...
class franceNewScreen extends StatefulWidget {
  @override
  State<franceNewScreen> createState() => _franceNewScreenState();
}

class _franceNewScreenState extends State<franceNewScreen> {
