...
class germanyBioMonitorScreen extends StatefulWidget {
  @override
  State<germanyBioMonitorScreen> createState() =>
      _germanyBioMonitorScreenState();
}

class _germanyBioMonitorScreenState extends State<germanyBioMonitorScreen> {
