...
class SwitzerlandScreen extends StatefulWidget {
  @override
  State<SwitzerlandScreen> createState() => _SwitzerlandScreenState();
}

class _SwitzerlandScreenState extends State<SwitzerlandScreen> {
  late TextEditingController dateController;
  late TextEditingController timeinput;

  late int sleepDuration = 0;
  List<Device> filterData = deviceData
      .where((device) => device.deviceId == "44" || device.deviceId == "26")
      .toList();
  @override
  void initState() {
